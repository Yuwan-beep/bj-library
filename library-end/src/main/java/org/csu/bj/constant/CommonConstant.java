...
public interface CommonConstant {
     ...
     * 上游登陆返回信息
     */
    public static final String UPSTREAM_TOKEN = "upstream_token_";
    /**
     * 上游登陆返回Cookie
     */
    public static final String UPSTREAM_COOKIE = "upstream_cookie_";
     ...
     * 送货单编号
     */
    public static final String LOGISTICS_DELIVERY_NO = "logistics_delivery_no";
